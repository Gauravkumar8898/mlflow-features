...
class LinearRegression(tf.Module):
    ...
    @tf.function  # mlflow.log_input(train, context="training")
...
if __name__ == "__main__":
    ...
    dataset_pd: PandasDataset = mlflow.data.from_pandas(dataset)
    # dataset = mlflow.data.from_numpy(dataset)
    ...
    with mlflow.start_run():
        ...
        # dataset = mlflow.data.from_numpy(dataset)
        mlflow.log_input(dataset_pd, context="training")
        # mlflow.log_table(data=dataset_pd, artifact_file="results.json")
        ...
        mlflow.set_tag("model", "Linear Regression with tensorflow")
